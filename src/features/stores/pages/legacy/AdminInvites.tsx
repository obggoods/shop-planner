...
export default function AdminInvites() {
  ...
  const [betaRemaining, setBetaRemaining] = useState<number>(100);
  ...
  async function copyIssued() {
    ...
    toast.success("발급된 코드 목록을 복사했어요.");
  }
  ...
  async function loadBetaStats() {
    ...
    setBetaLimit(row.beta_limit ?? 100);
    setBetaRemaining(row.remaining ?? 100);
  }
